...
<template>
  <section class="padding pt-32 pb-24">
    <div class="text-center max-w-2xl mx-auto">
      ...
      <!-- Billing Toggle -->
      <div
        class="inline-flex items-center bg-gray-100 rounded-xl p-1 mt-8"
      >
        <button
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14 max-w-5xl mx-auto">
      <div
        ...
        :class="
          plan.dark
            ? 'bg-gray-900 text-white shadow-2xl shadow-gray-900/20 border-2 border-indigo-500'
      ...
      >
        ...
        <h3
          ...
          :class="plan.dark ? 'text-white' : 'text-gray-900'"
        >
          {{ plan.name }}
        </h3>
        <p
          class="mt-2 text-sm leading-relaxed"
          :class="plan.dark ? 'text-gray-400' : 'text-gray-500'"
        >
          {{ plan.desc }}
        </p>
        ...
        <div class="mt-6 mb-8">
          ...
          <span :class="plan.dark ? 'text-gray-400' : 'text-gray-500'">
            /mo
          </span>
        </div>
        ...
        <ul class="space-y-3 flex-1">
          ...
          >
            <div
              ...
              :class="plan.dark ? 'bg-indigo-500/20' : 'bg-indigo-50'"
            >
              <svg
                width="12"
                height="12"
            ...
            <span
              class="text-sm"
              :class="plan.dark ? 'text-gray-300' : 'text-gray-600'"
              >{{ feature }}</span
            >
          </li>
        </ul>
        ...
        <button
          ...
          :class="
            plan.dark
              ...
              : 'border-2 border-gray-200 text-gray-900 hover:border-indigo-500 hover:text-indigo-600 hover:shadow-lg'
          "
        >
          {{ plan.cta }}
        </button>
    ...
    <div class="text-center mt-16">
      <p class="text-gray-500">
        ...
        <router-link
          to="/support"
          class="text-indigo-600 font-semibold hover:text-indigo-500 transition-colors"
